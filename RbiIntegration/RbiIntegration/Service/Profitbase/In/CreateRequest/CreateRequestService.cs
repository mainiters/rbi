...
using RbiIntegration.Service.Profitbase.In.CreateRequest.Model.Request;
using RbiIntegration.Service.Profitbase.In.CreateRequest.Model.Response;
using System;
...
namespace RbiIntegration.Service.Profitbase.In.CreateRequest
{
    /// <summary>
