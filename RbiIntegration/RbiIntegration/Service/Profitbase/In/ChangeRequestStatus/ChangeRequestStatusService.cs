...
using RbiIntegration.Service.Profitbase.In.ChangeRequestStatus.Model.Request;
using RbiIntegration.Service.Profitbase.In.ChangeRequestStatus.Model.Response;
using System;
...
namespace RbiIntegration.Service.Profitbase.In.ChangeRequestStatus
{
    /// <summary>
